...
/**
 * PreventionEightFragment subclass represents the eighth step in the Prevention Guide.
 */
public class PreventionEightFragment extends Fragment {

    public PreventionEightFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Setting the right image for the preventionImage object variable in Prevention Guide Step Eight
        preventionImage.setImageResource(R.drawable.prevention_guide_slide_eight);
