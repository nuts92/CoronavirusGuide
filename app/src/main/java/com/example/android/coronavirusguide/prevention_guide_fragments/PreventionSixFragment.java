...
/**
 * PreventionSixFragment subclass represents the sixth step in the Prevention Guide.
 */
public class PreventionSixFragment extends Fragment {

    public PreventionSixFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Setting the right image for the preventionImage object variable in Prevention Guide Step Six
        preventionImage.setImageResource(R.drawable.prevention_guide_slide_six);
