...
public class PreventionGuideActivity extends AppCompatActivity {
    ...
    //Declaring and initialing a constant that represents the number of Prevention Guide pages/fragments to be displayed.
    ...
    private class PreventionAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                ...
                case 2: // Fragment number 2 - This will show PreventionThreeFragment
                    return new PreventionThreeFragment();
                case 3: // Fragment number 2 - This will show PreventionFourFragment
                    return new PreventionFourFragment();
                case 4: // Fragment number 2 - This will show PreventionFiveFragment
                    return new PreventionFiveFragment();
                case 5: // Fragment number 2 - This will show PreventionSixFragment
                    return new PreventionSixFragment();
                case 6: // Fragment number 2 - This will show PreventionSevenFragment
                    return new PreventionSevenFragment();
                case 7: // Fragment number 2 - This will show PreventionEightFragment
