...
/**
 * ManageStressFourFragment subclass represents the fourth step in the Manage Stress Guide.
 */
public class ManageStressFourFragment extends Fragment {

    public ManageStressFourFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Setting the right image for the manageStressImage object variable in Manage Stress Guide Step Four
        manageStressImage.setImageResource(R.drawable.manage_stress_slide_four);
